import { balanceAuthMiddleware, xStampMiddleware } from '../../middleware';
...
router.get('/waas/private-balance', xStampMiddleware, balanceAuthMiddleware, async (req: Request, res: Response) => {
...
router.get('/waas/refresh-cache', xStampMiddleware, balanceAuthMiddleware, async (req: Request, res: Response) => {
...
router.get('/waas/stuck-utxo-balance', xStampMiddleware, balanceAuthMiddleware, async (req: Request, res: Response) => {
  const { organizationId, userId, walletAddress } = parseQueryParams<{
    organizationId: string;
    userId: string;
    walletAddress: string;
