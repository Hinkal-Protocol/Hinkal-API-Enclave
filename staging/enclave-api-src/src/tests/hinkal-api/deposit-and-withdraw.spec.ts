...
describe('deposit-and-withdraw route', () => {
  ...
  it('response is signed by enclave key', async () => {
    ...
    expect(verify.verify({ key: verificationPublicKey, dsaEncoding: 'ieee-p1363' }, signature, 'base64')).toBe(true);
  });
